        ...
        <div class="news-detail">
            ...
            <div class="news-cont">
                ...
                <ul>
                    ...
                    <li>гарантия <b>на оригинальные запасные части</b>, установленные в автосалоне БорАВТО, — 1 год.</li>
...
-->
                <hr>
                <p class="disclaimer"> 			<sup>*</sup> Цена действительна на 01.10.2017. Не является публичной офертой. Цена может быть изменена в одностороннем порядке. Текущую цену уточняйте по телефону +7 (47354) 5-11-55.</p>
            </div>
        </div>
